...
import com.example.lenovo.demo_grideview_scoreview.adapter.SuperVideoAdapter;
import com.example.lenovo.demo_grideview_scoreview.been.VideoListBean;
...
public class VideoViewActivity extends AppCompatActivity {
    ...
    private void initPlayer() {
        player = SuperPlayerManage.getSuperManage().initialize(this);    //在这里注册SuperPlayer
        player.setShowTopControl(false).setSupportGesture(false);       //设置初始化为不显示控制条，去除手势操作
    }
